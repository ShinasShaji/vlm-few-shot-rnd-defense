...
\begin{columns}[T]
  \column{\customcolumnwidth}
    ...
    \begin{itemize}
      ...
      \item \emph{Multiple} image \emph{modalities}:
        \begin{itemize}
      ...
      %     \item 395 test cases
      %   \end{itemize}
      \item Diagnoses and features are \emph{not uniformly distributed}
      \item Additional task information: \emph{describes} each \emph{checklist feature}
      \item \emph{Task-specific} dataset -- likely not present in VLM pre-training data
    \end{itemize}
  \column{\customcolumnwidth}
    \vspace{-0.5em}
    #1
